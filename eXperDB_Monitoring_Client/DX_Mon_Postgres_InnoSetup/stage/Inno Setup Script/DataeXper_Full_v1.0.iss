...
#define MyAppExeName4 "iDast.MonTibero.exe"
...
AppId={{A6346E76-D650-44FE-A4F1-A26CD40E52AF}}
AppName={#MyAppName}
...
OutputDir=C:\Temp
OutputBaseFilename=DataeXper_Full_v1.0
...
Source: "C:\YUN_PROJECT\ConsoleApplication1\bin\Debug\reg_DX.exe"; DestDir: {tmp}; Flags: deleteafterinstall;
...
Filename: "{tmp}\reg_DX.exe";  Flags: runhidden;
