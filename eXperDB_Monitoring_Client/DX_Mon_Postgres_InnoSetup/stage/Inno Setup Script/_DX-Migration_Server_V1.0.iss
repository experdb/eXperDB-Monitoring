...
#define MyAppName "DX-MIGRATOR.Server"
#define MyAppVersion "1.0"
#define MyAppPublisher "Webcash"
#define MyAppURL "http://www.webcash.co.kr"

#define MyAppExeName  "DataeXper"
#define MyAppExeName1 "DX.Migration.Server.Daemon.exe"
#define MyAppExeName2 "DX.Migration.Server.Monitor.exe"
       

#define MyPgName "DataeXper"
#define MyPgName1 "DX-MIGRATOR-SERVER"
#define MyPgName2 "DX-MIGRATOR-MONITOR"
...
AppId={{769A24A8-A1E6-4B65-937B-C6C135833E12}}
AppName={#MyAppName}
...
OutputDir=C:\Temp
OutputBaseFilename=DX-MIGRATOR.Server_v1.0
...
Name: odp; Description: "Oracle Data Provider"; Types: full win64 custom; Flags: fixed
...
Source: "C:\Work\idast\IDAST\bin\Debug\Install_ODBC.bat"; DestDir: "{app}"; Flags: ignoreversion
                                                        

Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\DX.Migration.Server.Daemon.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Work\idast\DX.Migration.Server.Monitor\bin\Debug\DX.Migration.Server.Monitor.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Work\idast\Setups\Sybase IQ\X64\*.dll"; DestDir: "{app}"; Flags: ignoreversion

Source: "C:\Work\idast\Setups\anthology.dll"; DestDir: "{app}\Shared\lib\"; Flags: ignoreversion
...
;Source: "C:\Work\idast\Setups\DX_SVR\*.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.Common\bin\Debug\DX.Common.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\Cfg\*"; DestDir: "{app}\Shared\Cfg\"; Flags: ignoreversion
Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\dictionary\name\*"; DestDir: "{app}\Shared\dictionary\name\"; Flags: ignoreversion
Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\dictionary\new_address\*"; DestDir: "{app}\Shared\dictionary\new_address\"; Flags: ignoreversion
Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\dictionary\old_address\*"; DestDir: "{app}\Shared\dictionary\old_address\"; Flags: ignoreversion
Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\dictionary\new_address_detail\*"; DestDir: "{app}\Shared\dictionary\new_address_detail\"; Flags: ignoreversion
Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\dictionary\old_address_detail\*"; DestDir: "{app}\Shared\dictionary\old_address_detail\"; Flags: ignoreversion
                                                

Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\Img\*"; DestDir: "{app}\Shared\Img\"; Flags: ignoreversion
;Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\lib\*"; DestDir: "{app}\Shared\lib\"; Flags: ignoreversion
Source: "C:\Work\idast\DX_MigrationSvr\bin\Debug\Shared\PGBIN\*"; DestDir: "{app}\Shared\PGBIN\"; Flags: ignoreversion
...
Source: "C:\prot\Setup\Setups1\Postgres_ODBC\win64\*"; DestDir: "{app}\Shared\Lib\Postgres\win64\"; Flags: ignoreversion; Components: postgre\win64
...
;Source: "C:\Work\idast\Setups\NetFx20SP2_x64.exe"; DestDir: {tmp}; Flags: deleteafterinstall; Check: FrameworkIsNotInstalled2
;Source: "C:\Work\idast\DX.Reg\bin\Debug\DX.Reg.exe"; DestDir: {tmp}; Flags: deleteafterinstall;

Source: "C:\Work\idast\Setups\vcredist_Redistribute\vcredist_x64_2005.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
Source: "C:\Work\idast\Setups\vcredist_Redistribute\vcredist_x64_2008.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
Source: "C:\Work\idast\Setups\vcredist_Redistribute\vcredist_x64_2010.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
...
Name: "{commondesktop}\{#MyPgName2}"; Filename: "{app}\{#MyAppExeName2}"; Tasks: desktopicon
;Name: "{commondesktop}\{#MyPgName3}"; Filename: "{app}\{#MyAppExeName3}"; Tasks: desktopicon
;Name: "{commondesktop}\{#MyPgName4}"; Filename: "{app}\{#MyAppExeName4}"; Tasks: desktopicon
;Name: "{commondesktop}\{#MyPgName5}"; Filename: "{app}\{#MyAppExeName5}"; Tasks: desktopicon
...
Filename: "{app}\{#MyAppExeName2}"; Description: "{cm:LaunchProgram,{#StringChange(MyPgName2, '&', '&&')}}"; Flags: nowait postinstall skipifsilent unchecked
;Filename: "{app}\{#MyAppExeName3}"; Description: "{cm:LaunchProgram,{#StringChange(MyPgName3, '&', '&&')}}"; Flags: nowait postinstall skipifsilent unchecked
;Filename: "{app}\{#MyAppExeName4}"; Description: "{cm:LaunchProgram,{#StringChange(MyPgName4, '&', '&&')}}"; Flags: nowait postinstall skipifsilent unchecked
;Filename: "{app}\{#MyAppExeName5}"; Description: "{cm:LaunchProgram,{#StringChange(MyPgName5, '&', '&&')}}"; Flags: nowait postinstall skipifsilent unchecked     
...
;Filename: "{tmp}\NetFx20SP2_x64.exe"; Check: FrameworkIsNotInstalled2 ;
Filename: "{app}\Install_ODBC.bat";  Flags: runhidden;
;Filename: "{tmp}\DX.Reg.exe";  Flags: runhidden;

;Filename: {tmp}\vcredist_x64_2005.exe; Parameters: "/q:a /c:""msiexec.exe /qb /i vcredist.msi"" "
;Filename: {tmp}\vcredist_x64_2008.exe; Parameters: "/q:a /c:""msiexec.exe /qb /i vcredist.msi"" "
Filename: {tmp}\vcredist_x64_2005.exe; Parameters: "/q:a /c:""VCREDI~2.EXE /q:a /c:""""msiexec /i vcredist.msi /qn"""" """; WorkingDir: {tmp}; StatusMsg: Installing...

Filename: {tmp}\vcredist_x64_2010.exe; Parameters: "/q:a /c:""msiexec.exe /qb /i vcredist.msi"" ";
...
begin
  ...
  SaveValueToXML(AppPath + '\Configure.xml', '//configuration/public/appender[@name="cfgAppender"]/BackupPath/@value', AppPath + '\Log\Backup');
...
function FrameworkIsNotInstalled2: Boolean;
begin
