...
#define MyAppName "DX-META"
#define MyAppVersion "1.0"
#define MyAppPublisher "Webcash"
#define MyAppURL "http://www.webcash.co.kr"

#define MyAppExeName  "DataeXper"
#define MyAppExeName1 "DX.Meta.exe"
;#define MyAppExeName2 "DX.Migration.Developer.exe"
;#define MyAppExeName3 "DX.MonOracle.exe"
;#define MyAppExeName4 "DX.MonTibero.exe"
;#define MyAppExeName5 "DX.Automation.exe"


#define MyPgName "DataeXper"
#define MyPgName1 "DX.Meta"
;#define MyPgName2 "DX.Migration"
;#define MyPgName3 "DX.MonOracle"
;#define MyPgName4 "DX.MonTibero"
;#define MyPgName5 "DX.Auto"
...
AppId={{4E917B79-9470-4B1F-A91A-DE4BBCFC88C0}}
AppName={#MyAppName}
...
LicenseFile=Korean_License_Meta.rtf
OutputDir=C:\Temp
OutputBaseFilename=DX-META.Client_v1.0
...
Source: "C:\Work\idast\iDast.Meta\bin\Debug\DX.Meta.exe"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.Migration\bin\Debug\DX.Migration.Developer.exe"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.MonOracle\bin\Debug\DX.MonOracle.exe"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.MonTibero\bin\Debug\DX.MonTibero.exe"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.Automation\bin\Debug\DX.Automation.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Work\idast\iDast.Meta\bin\Debug\LogConfiguration.xml"; DestDir: "{app}"; Flags: ignoreversion
; iDast DLL File
...
Source: "C:\Work\idast\iDast.Meta\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.Migration\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.MonOracle\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.MonTibero\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\Work\idast\iDast.Automation\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion
...
; ODBC Driver Tibero
Source: "C:\prot\Setup\Setups1\Postgres_ODBC\win32\*"; DestDir: "{app}\Shared\Lib\Postgres\win32\"; Flags: ignoreversion
...
Filename: "{app}\Shared\Lib\Postgres\win32\ODBCRun.bat"; Flags: runhidden;
