...
#define MyAppName "Data eXper Monitoring for PostgreSQL"
#define MyAppVersion "1.0.0.0"
#define MyAppPublisher "Webcash"
#define MyAppURL "http://www.webcash.co.kr"
#define MyAppExeName "DX.MonPostgres.exe"
#define MyPgName "Data eXper"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{C8B4B28A-2A08-4EAB-9B17-D1FF42A5F48B}}
AppName={#MyAppName}
...
[Files]
; IDast Program File
Source: "C:\Work\idast\iDast.MonPostgres\bin\Debug\DX.MonPostgres.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Work\idast\iDast.MonPostgres\bin\Debug\image\*.*"; DestDir: "{app}\image"; Flags: ignoreversion
Source: "C:\Work\idast\iDast.MonPostgres\bin\Debug\language\*.*"; DestDir: "{app}\language"; Flags: ignoreversion
Source: "C:\Work\idast\iDast.MonPostgres\bin\Debug\Sounds\*.*"; DestDir: "{app}\Sounds"; Flags: ignoreversion
; iDast DLL File
Source: "C:\Work\idast\iDast.MonPostgres\bin\Debug\*.*"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\prot\Setup\Setups1\Postgres_ODBC\win64\*"; DestDir: "{app}\Shared\Lib\Postgres\win64\"; Flags: ignoreversion; Components: postgre\win64; Check: IsWin64

;Framework 
Source: "C:\Work\idast\Setups\dotNetFx40_Full_x86_X64.exe"; DestDir: "{tmp}"; Check : not IsRequiredDotNetDetected; 
...
//       MsgBox('{#MyAppName} 은 Mivrosoft .NET Framework 4.0 Client Profile의 설치를 필요합니다.'#13#13'본 프로그램은 Microsoft .NET Framework 4.0 Clicnt Profile의 설치를 포함하고 있습니다'
//         , mbInformation, MB_OK);        
//    end
//    
//    result := true;
