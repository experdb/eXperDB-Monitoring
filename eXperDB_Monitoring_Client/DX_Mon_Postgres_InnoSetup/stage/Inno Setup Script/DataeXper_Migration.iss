...
#define MyAppName "DataeXper_Migration"
...
OutputDir=C:\Temp
OutputBaseFilename=DataeXper_Migration
...
Source: "C:\Work\idast\iDast.Main\bin\Debug\iDAST.Main.exe"; DestDir: "{app}"; Flags: ignoreversion
