...
public class SocketExecutorForeXperDBMA implements Runnable {
	private static Logger log = LogManager.getLogger(SocketExecutorForeXperDBMA.class);
	...
	public SocketExecutorForeXperDBMA(Socket s) {
		client		= s;
...
//		        log.debug("SocketApplication Loading END............");
		        ...
		        try {
		        	...
		        	outputArray = clApp.perform(_tran_cd, _tran_req_data);
